...
int main(void)
{
    ...
    //创建任务taskLCD
    xTaskCreate(taskLCD, "taskLCD", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY, NULL);
	//创建任务taskLED
    xTaskCreate(taskLED, "taskLED", configMINIMAL_STACK_SIZE, NULL, tskIDLE_PRIORITY + 2, NULL);
